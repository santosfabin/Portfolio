...
Este repositório contém o código-fonte da minha página de portfólio, onde apresento meus principais projetos, experiências e habilidades com desenvolvimento.
...
**Desenvolvedor Full-Stack — Plumaa** · Set 2025 – Jul 2026
Otimização da interface em React/TypeScript/Tailwind, com padronização e criação de componentes. Consumo do estado global existente via React Query. Integração de pagamentos com AbacatePay e trabalho contínuo com Stripe para testes automatizados. Testes com Playwright e uso de Digital Ocean na infraestrutura do projeto.

**Desenvolvedor Front-End — Plati Ai** · Jul 2025 – Set 2025
Correção de bugs críticos em produção causados pelo alto volume de logs soltos e desorganizados. Implementação de visualização de logs no front-end, agrupando as informações de forma simples e clara, facilitando o diagnóstico de erros. Participação na migração gradual de API, mantendo a interface estável.

**Desenvolvedor Back-End — Alpha Digital (Alpha EdTech)** · Mai 2025 – Jul 2025
Melhorias na API Laravel: paginação e estruturação de dados nos endpoints, reduzindo o tempo de resposta de 2-5s para 1-3s.
